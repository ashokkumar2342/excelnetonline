        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.login.post') }}" method="post" class="add_form">
                    {{ csrf_field() }}
                    <div class="mb-2">
                        <input type="text" name="email" required="" class="form-control" placeholder="Email Id OR Mobile No." aria-label="Name" aria-describedby="email-addon">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <a href="#" class="btn bg-gradient-danger w-100 my-4 mb-2">Forgot Password</a>
                    </div>
                </form>
            </div>
        </div>
