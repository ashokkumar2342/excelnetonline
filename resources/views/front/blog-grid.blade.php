...
<!-- Mirrored from html.ditsolution.net/drtheme/dreamhub/digital-marketing2/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Oct 2023 09:00:43 GMT -->
<head>
    <meta charset="UTF-8">
...
<div class="blog-grid-section">
    <div class="container">
	    <div class="row">
		    <div class="col-lg-4">
				<div class="Grid-single-box wow fadeInLeft animated">
				    <div class="Grid-thumb">
						 <a href="#"><img src="assets/images/resource/blog1.jpg" alt=""></a>
				    </div>
					<div class="Grid-content">
						<h2><a href="blog.html">Marketing is the best policy</a></h2>
						<p>What is Lorem Ipsum? Lorem Ipsum is simply <br> dummy text of the printing and</p>
					</div>
				</div>
			</div>
	        <div class="col-lg-4">
				<div class="Grid-single-box wow fadeInUp animated">
				    <div class="Grid-thumb">
			...
			<div class="col-lg-4">
				<div class="Grid-single-box wow fadeInRight animated">
				    <div class="Grid-thumb">
			...
			<div class="col-lg-4">
				<div class="Grid-single-box">
					<div class="Grid-content">
						<h2><a href="blog.html">Hello World!</a></h2>
						<p>Welcome to WordPress. This is your first post. Edit <br> or delete it, then</p>
					</div>
				</div>
			</div>
		 </div>
